 ...
 *  
 * The chess structure is from the online games(any can searched by Baidu or Google) but the content has been modified
 * 
 *
 */
package UI;
...
public class UI extends JFrame implements ActionListener {  
    ...
    public UI() {  
        ...
        bar.add(Menu);  
        setJMenuBar(bar);  
        setTitle("Advanced Xiangqi Game");  
    ...
    public void actionPerformed(ActionEvent e) {  
        if (e.getSource() == NewChess) {  
          ...
          System.exit(0);
        	...
        	/**
        	 * if there is no record, player cannot undo and get an error message
        	 */
