...
public class Main {
	...
	public static void main(String args[]) throws IOException { 
		...
		if(input.equals("No") || input.equals("n")) {
			System.out.println("The strategy you are using is 2143. \nThat means AI player should concern “Chocolate Candy” number first,\nthen “Score”, “Striped Candy” number and “Wrapped Candy” number.");
			System.out.println("This process needs a little time. Please wait for a few miuntes.");
			int STRATEGY = 2143 ;
			int LEVEL = 0;
			Game game;
			simpleAI simple;
			...
			System.out.println("Hello! Human Player~ Enjoy your game~");
			int LEVEL = 0;
			Game game;
			simpleAI simple;
			int STRATEGY = 2143 ;
